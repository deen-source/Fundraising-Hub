...
export const SCENARIOS: Scenario[] = [
  {
    ...
    bullets: [
      'The VC will want to hear your pitch in under 2 minutes',
      'Expect questions about your value proposition',
      'You\'ll need to answer follow-up questions on the spot',
      'The VC will assess if you leave a memorable impression',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Casual conversation about what you\'re building',
      'Questions about why you\'re the right founder for this',
      'Discussion about your team and early traction',
      'The VC will probe your market understanding',
    ],
  ...
  },
  {
    ...
    bullets: [
      'You\'ll deliver a structured 2-minute pitch',
      'Expect rapid-fire Q&A immediately after',
      'Questions about your team\'s background and credentials',
      'The VC will challenge your market size assumptions',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Deep technical questions about your business model',
      'You\'ll need to defend your unit economics with data',
      'Discussion about competitive risks and mitigation plans',
      'The VC will stress-test your operational assumptions',
    ],
