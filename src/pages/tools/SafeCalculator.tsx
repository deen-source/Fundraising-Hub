                ...
                <div className="flex items-start justify-between flex-wrap gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      ...
                      <h1 className="text-4xl font-bold text-white">SAFE Note Calculator</h1>
                    </div>
                  ...
                  {result && (
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                      <div className="text-cyan-100/60 text-sm mb-1">Your Ownership</div>
                      <div className="text-3xl font-bold text-white">{result.ownershipPercentage.toFixed(2)}%</div>
                      <div className="text-cyan-100/60 text-xs mt-1">of company post-conversion</div>
                    </div>
                  )}
                </div>
              </div>
